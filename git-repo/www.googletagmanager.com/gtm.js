...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "function": "__gtes",
                "vtp_eventSettingsTable": ["list", ["map", "parameter", "source", "parameterValue", ["macro", 6]],
                    ["map", "parameter", "medium", "parameterValue", ["macro", 7]],
                    ["map", "parameter", "campaign", "parameterValue", ["macro", 8]]
                ]
            }, {
                "function": "__u",
                "vtp_component": "URL",
            ...
            "tags": [{
                ...
                "vtp_eventName": "redirect_to_checkout",
                "vtp_measurementIdOverride": "G-GH3R62YJ10",
                ...
                "vtp_sendEcommerceData": false,
                "vtp_enhancedUserId": false,
                "vtp_eventSettingsTable": ["list", ["map", "parameter", "source", "parameterValue", ["macro", 3]],
                    ["map", "parameter", "medium", "parameterValue", ["macro", 4]],
                    ["map", "parameter", "campaign", "parameterValue", ["macro", 5]]
                ],
                "vtp_eventName": "purchase_subscription",
                "vtp_measurementIdOverride": "G-GH3R62YJ10",
                "vtp_eventSettingsVariable": ["macro", 9],
                "vtp_enableUserProperties": true,
                "vtp_enableMoreSettingsOption": true,
                "vtp_enableEuid": true,
                "vtp_migratedToV2": true,
                ...
                "vtp_uniqueTriggerId": "203210639_10",
                "tag_id": 29
            }, {
                "function": "__html",
                "metadata": ["map"],
                "once_per_event": true,
                "vtp_html": "\u003Cscript type=\"text\/gtmscript\"\u003E(function(){function a(h){for(var c=window.location.search.substring(1).split(\"\\x26\"),b=0;b\u003Cc.length;b++){var d=c[b].split(\"\\x3d\");if(d[0]===h)return decodeURIComponent(d[1])}return\"\"}var e=a(\"utm_source\"),f=a(\"utm_medium\"),g=a(\"utm_campaign\");e\u0026\u0026(document.cookie=\"utm_source\\x3d\"+e+\"; path\\x3d\/\");f\u0026\u0026(document.cookie=\"utm_medium\\x3d\"+f+\"; path\\x3d\/\");g\u0026\u0026(document.cookie=\"utm_campaign\\x3d\"+g+\"; path\\x3d\/\")})();\u003C\/script\u003E\n",
            ...
            "predicates": [{
                ...
                "function": "_cn",
                "arg0": ["macro", 1],
                "arg1": "https:\/\/nicolaipalmkvist.lemonsqueezy.com\/buy\/5d5db7b7-d213-42e1-a116-797433c7e158"
            }, {
                "function": "_cn",
                "arg0": ["macro", 1],
                "arg1": "https:\/\/nicolaipalmkvist.com\/choose-your-plan\/"
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "gtm.linkClick"
                ...
                "function": "_cn",
                "arg0": ["macro", 1],
                "arg1": "https:\/\/nicolaipalmkvist.com\/new-customer\/"
            }, {
                "function": "_eq",
                "arg0": ["macro", 1],
                "arg1": "https:\/\/nicolaipalmkvist.lemonsqueezy.com\/checkout"
            }, {
                "function": "_re",
                "arg0": ["macro", 1],
                "arg1": ".*\\?utm_.*"
        ...
        "blob": {
            ...
            "14": "6611",
            "15": "1",
            "16": "ChEI8P750AYQrOmYntDM6bbnARIdAB81WG0ssFEiX+PbDpIKObJIhRyb9JWELJmb9PkaAgjL",
            "19": "dataLayer",
            "20": "",
            "21": "www.googletagmanager.com",
            "22": "eyIwIjoiRUciLCIxIjoiRUctQyIsIjIiOmZhbHNlLCIzIjoiZ29vZ2xlLmNvbS5lZyIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiIsIjkiOmZhbHNlfQ",
    ...
    */
    ...
    var Gn = function(a, b, c) {
            a instanceof En && (a = a.resolve(Fn.O(b, c)), b = Ab);
            return {
                ws: a,
                onSuccess: b
            }
    ...
    Jn.prototype.K = function(a) {
        ...
        var b = Bn();
        this.H[b] = a;
        return 'google_tag_manager["rm"]["' + el() + '"](' + b + ")"
    };
    var Kn, En = function(a) {
    ...
    Hn.prototype.O = function(a, b) {
        var c = String(Bn());
        this.H[c] = [a, b];
        return c
    };
    Hn.prototype.K = function(a) {
        var b = this,
            c = a ? 0 : 1;
        return function(d) {
            R(a ? 134 : 135);
    ...
    function IG(a) {
        ...
        var c;
        a: {
            for (var d = hF(this).cachedModelValues, e = m(a.split(".")), f = e.next(); !f.done; f = e.next()) {
                if (d == null) {
                    c = void 0;
                    break a
                }
    ...
    function HO(a, b) {
        b = b === void 0 ? !0 : b;
        var c;
        if (!M(a) || !ph(b)) throw L(this.getName(), ["string", "boolean|undefined"], arguments);
        N(this, "get_cookies", a);
        c = Wd(fq(a, void 0, !!b), this.T);
        return c
    }
    ...
    function gS(a, b, c, d, e) {
        if (!((M(a) || lh(a)) && ih(b) && ih(c) && ph(d) && ph(e))) throw L(this.getName(), ["string|OpaqueValue", "function", "function", "boolean|undefined", "boolean|undefined"], arguments);
        var f = hF(this),
            g = PE();
        d && g(3);
        e && (g(1), g(2));
    ...
    function FS(a, b, c) {
        c = c === void 0 ? !0 : c;
        var d = [];
        if (!M(a) || !M(b) || !oh(c)) throw L(this.getName(), ["string", "string", "boolean|undefined"], arguments);
        d = fq(b, a, !!c);
        return Wd(d)
    }
    ...
    function YS(a, b, c, d) {
        if (arguments.length < 2 || !gh(d) || !gh(c)) throw L(this.getName(), ["any", "any", "Object|undefined", "Object|undefined"], arguments);
        var e = c ? B(c) : {},
            f = B(a),
    ...
    Z.securityGroups.get_cookies = ["google"],
        function() {
            function a(b, c) {
                ...
                return {
                    assert: function(f, g) {
                        if (!Cb(g)) throw e(f, {}, "Cookie name must be a string.");
                        if (c !== "any" &&
    ...
    function UT() {
        ...
        b.onHtmlSuccess = In(!0), b.onHtmlFailure = In(!1);
        return b
    }
